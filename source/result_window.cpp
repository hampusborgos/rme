...
SearchResultWindow::SearchResultWindow(wxWindow* parent) : wxPanel(parent, wxID_ANY)
{
	wxSizer* sizer = newd wxBoxSizer(wxVERTICAL);
	result_list =
	    newd wxListBox(this, wxID_ANY, wxDefaultPosition, wxSize(200, 330), 0, nullptr, wxLB_SINGLE | wxLB_ALWAYS_SB);
...
SearchResultWindow::~SearchResultWindow() { Clear(); }
...
void SearchResultWindow::OnClickClear(wxCommandEvent& WXUNUSED(event)) { Clear(); }
