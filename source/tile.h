...
public:
	...
	int const getX() const {return location->getPosition().x;}
	int const getY() const {return location->getPosition().y;}
	int const getZ() const {return location->getPosition().z;}
