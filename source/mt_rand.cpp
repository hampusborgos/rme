...
static double mt_get_double(void *vstate) { return mt_get(vstate) / 4294967296.0; }
...
void mt_seed(unsigned long s) { mt_set(&mt_state, s); }

unsigned long mt_randi() { return mt_get(&mt_state); }

double mt_randd() { return mt_get_double(&mt_state); }
