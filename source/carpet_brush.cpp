...
CarpetBrush::CarpetBrush() : look_id(0)
{
	////
}
...
bool CarpetBrush::canDraw(BaseMap* map, const Position& position) const { return true; }
...
{
	static const auto hasMatchingCarpetBrushAtTile = [](BaseMap* map, CarpetBrush* carpetBrush, uint32_t x, uint32_t y,
	                                                    uint32_t z) -> bool {
